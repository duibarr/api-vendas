...
import { AddOrderFieldtoOrders1671806125765 } from './migrations/1671806125765-AddOrderFieldToOrders';
...
export const dataSource = new DataSource({
    ...
    password: 'docker',
    database: 'apivendas',
    entities: [User, Product, Customer, Order, OrdersProducts, UserToken],
    migrations: [
        ...
        AddOrderFieldtoOrders1671806125765,
    ],
});
